...
<head>
    ...
    <link rel="icon" href="<?= base_url() ?>/assets/images/logo8.png" type="image/png">
...
<body onload="openEyes()">
    ...
    <div class="container" id="loginContainer">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url(); ?>assets/images/logo8.png"
        ...
        <g>
            ...
            <path id="headOutline" class="st2"
                d="M832,279c38.4,0,74.6,15.9,101.7,44.7C961,352.6,976,391.1,976,432s-15,79.4-42.3,108.3
        ...
        <ellipse id="eyeLeft" transform="matrix(0.9962 -8.715574e-02 8.715574e-02 0.9962 -27.4684 69.9878)" class="st5"
            cx="787.8" cy="349.6" rx="29.2" ry="36.1" />
        <ellipse id="eyeRight" transform="matrix(0.126 -0.992 0.992 0.126 416.1085 1177.406)" class="st5" cx="876.2"
            cy="352.6" rx="36.2" ry="29.1" />
        ...
        <g>
            ...
            <ellipse id="closedEyeLeft" transform="matrix(0.9962 -8.715574e-02 8.715574e-02 0.9962 -27.726 70.0864)"
                class="st10" cx="788.8" cy="352.6" rx="29.2" ry="36.1" />
            <path id="closedEyeLeftLid" class="st11"
                d="M818.3,354.9c-1.4-1.1-12.3-9.2-29.9-7.9c-18.3,1.4-28.3,11.9-29.4,13.1" />
        </g>
        <g>
            <ellipse id="closedEyeRight" transform="matrix(0.126 -0.992 0.992 0.126 415.1164 1178.28)" class="st10"
                cx="876.2" cy="353.6" rx="36.2" ry="29.1" />
            <path id="closedEyeRightLid" class="st11"
                d="M906,359.7c-1.2-1.3-10.6-11.2-28.1-13c-18.3-1.8-29.9,6.8-31.2,7.8" />
        </g>
        </svg>
...
-->
        ...
        ?>
                ...
                <input onfocus="openEyes();" onblur="movePupilsToCenter();" name="username" id="username" type="text"
                    placeholder="Username">
            </div>
        </div>
        <div style="margin: 40px 40px;">
            <div style="text-align: center">
                <input onfocus="closeEyes();" onblur="openEyes();" name="password" id="password" type="password"
