            ...
            <div class="box box-widget widget-user">
                <div class="widget-user-header bg-green-active">
                    <p style="text-align: center;">
                        <span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di POSLapan</span>
                    </p>
                    <h3 class="widget-user-username"></h3>
                    <h5 class="widget-user-desc"></h5>
                </div>
                <div class="widget-user-image">
                    <img class="img-circle" src="<?php echo base_url(); ?>assets/dist/img/logo8.png">
                </div>
                <div class="box-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-4 border-right">
                            <div class="description-block">
                                <h5 class="description-header">Kelompok 8 UPN VETERAN JATIM,
                                    SURABAYA</h5>
                            </div>
                            <center>
