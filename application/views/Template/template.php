...
<head>
    ...
    <title>POSLapan | Dashboard</title>
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <span class="logo-lg"><b>POSLapan</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url('uploads/operator/') . $foto; ?>" class="user-image"
                                    alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="<?php echo base_url('uploads/operator/') . $foto; ?>" class="img-circle"
                                        alt="User Image">
                                    <p>
                                        <?php echo $this->session->userdata['username']; ?>
                                        <small>Kelompok 8</small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <?php $tahun =  date('Y');
								$bulan =  date('m'); ?>
                            <li><a href="<?php echo base_url() ?>index.php/lapharian/index/<?= $tahun ?>/<?= $bulan ?>"><i
                                        class="fa fa-circle-o"></i>LAPORAN HARIAN</a></li>
                            <li><a href="<?php echo base_url() ?>index.php/lapbulanan/index/<?= $tahun ?>"><i
                                        class="fa fa-circle-o"></i>LAPORAN BULANAN</a></li>
                            <li><a href="<?php echo base_url() ?>index.php/laporan"><i
                                        class="fa fa-circle-o"></i>LAPORAN PEMBAYARAN</a></li>
                        </ul>
                    </li>
                </ul>
                <?php else : ?>
        ...
        <footer class="main-footer">
            <strong>Project <a href="#">Kelompok 8</a> </strong>POSLapan
        </footer>
        <!-- /.control-sidebar -->
